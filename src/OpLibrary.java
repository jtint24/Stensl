public class OpLibrary {
    ...
    public static Operation addition = new Operation(addFunction, 2, doubleFloat);
    ...
    public static Operation multiplication = new Operation(multFunction, 2, doubleFloat);
    ...
    public static Operation subtraction = new Operation(subFunction, 2, doubleFloat);
    private static OpFunction divFunction = (args) -> new Datum(String.valueOf(Float.parseFloat(args[0].getValue())/Float.parseFloat(args[1].getValue())), "float");
    public static Operation division = new Operation(divFunction, 2, doubleFloat);
    private static OpFunction passFunction = (args) -> args[0];
    public static Operation pass = new Operation(passFunction, 1, singleFloat);
}
