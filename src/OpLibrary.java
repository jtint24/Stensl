public class OpLibrary {
    ...
    public static Operation addition = new Operation(addFunction, doubleFloat, "float", OpPrecedence.ADDITIVE, "addition");
    ...
    public static Operation multiplication = new Operation(multFunction, doubleFloat, "float", OpPrecedence.MULTIPLICATIVE, "multiplication");
    ...
    public static Operation subtraction = new Operation(subFunction, doubleFloat, "float", OpPrecedence.ADDITIVE, "subtraction");
    ...
    public static Operation division = new Operation(divFunction, doubleFloat, "float", OpPrecedence.MULTIPLICATIVE, "division");
    private static OpFunction passFunction = (args) -> args[0];
    public static Operation pass = new Operation(passFunction, singleFloat, "float", OpPrecedence.PASS, "pass");
    ...
    public static Operation intAddition = new Operation(intAddFunction, doubleInt, "int", OpPrecedence.ADDITIVE, "int add");
    ...
    public static Operation intMultiplication = new Operation(intMultFunction, doubleInt, "int", OpPrecedence.MULTIPLICATIVE, "int mult");
    ...
    public static Operation intSubtraction = new Operation(intSubFunction, doubleInt, "int", OpPrecedence.ADDITIVE, "int sub");
    ...
    public static Operation intDivision = new Operation(intDivFunction, doubleInt, "int", OpPrecedence.MULTIPLICATIVE, "int div");
    private static OpFunction intPassFunction = (args) -> args[0];
    public static Operation intPass = new Operation(intPassFunction, singleInt, "int", OpPrecedence.PASS, "int pass");
}
